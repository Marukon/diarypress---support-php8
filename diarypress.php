...
Plugin URI: https://wordpress.org/plugins/diarypress/
...
Version: 5.3
Author: Tom Howson
Author URI: https://wordpress.org/plugins/diarypress/
*/
...
// We would expect most to use CRON however for compatibility this is maintained.
	...
	function force_login()
	{
		...
		if ( ! is_user_logged_in() )
		{
            ...
            // 移除了这里之前存在的未初始化的$user变量的使用
            // 修复了PHP 8.4中报错的问题
			
			// 这里直接进入else条件分支，显示登录页面
            ...
            <p>You must log in to view this diary. If you want to <a href="'. get_bloginfo('wpurl') .'/wp-login.php">Click here</a></p>
...
class DiaryPressSettingsPage
{
    ...
    public function create_admin_page()
    {
        ...
        <div class="wrap">
			...
			<p>Beyond very occasional tests with newer versions of Wordpress, no active development will be performed on this plugin for the foreseeable future. Thank you for continuing to use the plugin and I hope you enjoy it. </p>
			</div>
        <?php
    }
